متوجه شدم ✔️
می‌خواهی **README فارسی** که داده بودم، به‌جای حالت SQL-like، فقط **CSV** را توضیح بدهد و به‌عنوان خروجی دوم معرفی کند.
...
پس نسخه‌ی اصلاح‌شده‌ی README را برایت **کامل و قابل‌کپی** می‌گذارم.

---

# 📄 **README.md (نسخه نهایی با JSON + CSV)**
...
### ✔ همراه با Accept Header برای CSV
